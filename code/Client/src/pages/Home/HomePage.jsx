...
import { faCheckToSlot, faUserShield } from '@fortawesome/free-solid-svg-icons';
import './homepage.css';
        ...
        <nav className="navbar ">
                    <div className="container-fluid">
                        <a className="navbar-brand">
                            <FontAwesomeIcon icon={faCheckToSlot} className="fa-check-to-slot fs-3 px-2 text-dark" />
                            E-Ballot
                        </a>
                        <div className="d-flex" role="search">
                            <ul className="navbar-nav">
                                <li className="nav-item">
                                <a className="nav-link nav-btn" aria-current="page" href="http://localhost:5173/admin">
            ...
            <div className="login-container">
                <div className="login-cmp shadow-lg border">
                    ...
                    <RegisterComponent voter={voter} setVoter={setVoter} constituencies={constituencies} onRegister={(voter) => handleRegister(voter)} modal={rModal} />
                </div>
            </div>
            {showProgress ? <ProgressComponent success={progress.success} warn={progress.warn} msg={progress.msg} onClose={() => handleProgressClose()} /> : null}
        </div>
    </>);
};
