...
const Elections = (src, options) => {
    ...
    let Election = {
        startDate: "", endDate: "", constituencyId: "",electionName:""
    }
    let Progress = {
    ...
    const handleAddElection = () => {
        ...
        if (election.endDate !== '' && election.startDate !== '' && election.constituencyId !== '' && election.electionName !== '') {
            ...
            <table className="table table-hover">
                ...
                {elections.map((election, index) => <tr key={index}>
                    ...
                    <td className="election-data">
                        ...
                        {/* <br/>{getConstituencyName(election.constituencyId)} */}
             
                         </td>
                         <td className="election-data">
                         {/* {election.electionName} */}
                        {getConstituencyName(election.constituencyId)}
                ...
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <AddElection constituencies={constituencies} election={election} setElection={setElection}
                         onElectionNameChange={setElectionName}
                        />
                    </div>
