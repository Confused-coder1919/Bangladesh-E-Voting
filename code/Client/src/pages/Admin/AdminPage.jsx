...
import vote from '../../assets/images/logo.png'
...
const AdminPage = () => {
    ...
    const [title, setTitle] = useState("Administration Dashboard");
        ...
        {isAdmin && login ?
            (<div className="d-flex h-100">
                ...
                <div className="tab-content contents bg-body-tertiary" id="v-pills-tabContent">
                    <nav className="navbar sticky-top shadow-sm" style={{backgroundColor:'#28a745'}}>
