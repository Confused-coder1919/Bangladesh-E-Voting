...
import backgroundSvg from '../../assets/images/bg1.svg';
    ...
    const getUserDetails = (uid) => {
        getUser(uid).then(u => {
            ...
            getActiveElectionsUser(u.data).then(e => {
                console.log(e);
                // console.log(e.data)
                setCountry(e[0].constituency.name);
        ...
        <>
            {isVoter === true ? (
                <div className="user-page-container">
                    {/* <img className="background-svg" src={backgroundSvg} alt="Background SVG" /> */}
                    {showProgress && <ProgressComponent onClose={() => closeProgress()} success={progress.warn} msg={progress.msg} warn={progress.warn} />}
                    <nav className="navbar navbar-expand-lg  shadow-lg">
                    <div className="container-fluid">
                        <span className="navbar-brand text-black">E-Ballot</span>
                        <div className="d-flex justify-content-center align-items-center">
                            <div className="usr-details d-flex flex-column justify-content-center align-items-end pe-2">
                                ...
                                <span className="fst-italic uid text-white">{userDetails.userId}</span>
                            </div>
                    ...
                    {/* New section with logo and text */}
                    <div className="logo-section">
                        <div className="d-flex justify-content-center align-items-center">
                            <img src={logo} style={{width:'10%',margin:'2%'}} alt="Logo" className="logo" />
                            <h1 className="logo-text">বাংলাদেশ নির্বাচন কমিশন <br/>
Bangladesh Election Commission</h1>
                        </div>
                    </div>
                   
                   
                    <div className="user-content">
                    <p>You are logged in from <b>{country}</b></p>
                            ...
                            <div className="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabIndex="0">
                                ...
                                <table className="table table-hover mt-3">
                                        ...
                                        {elections.map((election, index) => <tr key={index}>
                                            ...
                                            <td className="election-data">{election.electionName}</td>
                                            <td className="election-data">{election.constituency.name}</td>
                    ...
                    <div className="modal fade" id="c-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <div className="login-message">{progress.msg}</div>
            )}
</>
    );
};
